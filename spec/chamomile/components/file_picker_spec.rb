...
RSpec.describe Chamomile::FilePicker do
  ...
  def picker_with_entries(entries, **opts)
    ...
    msg = Chamomile::FilePickerReadDirMsg.new(id: fp.id, entries: entries)
    fp.update(msg)
    fp
  end
  ...
  describe "#init_cmd" do
    ...
    it "produces a FilePickerReadDirMsg" do
      ...
      expect(msg).to be_a(Chamomile::FilePickerReadDirMsg)
  ...
  describe "edge cases" do
    it "handles ReadDirMsg with wrong id" do
      fp = described_class.new
      msg = Chamomile::FilePickerReadDirMsg.new(id: "wrong", entries: sample_entries)
      fp.update(msg)
      expect(fp.highlighted_path).to be_nil
    end
  ...
  describe "multiple file pickers" do
    it "each only responds to its own messages" do
      ...
      msg1 = Chamomile::FilePickerReadDirMsg.new(id: fp1.id, entries: sample_entries)
      fp2.update(msg1)
