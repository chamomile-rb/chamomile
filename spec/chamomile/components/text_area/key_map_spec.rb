...
RSpec.describe "Chamomile::TextArea::DEFAULT_KEY_MAP" do
  let(:key_map) { Chamomile::TextArea::DEFAULT_KEY_MAP }
  ...
  it "maps enter to new_line" do
    ...
    expect(Chamomile::KeyBinding.key_matches?(msg, key_map, :new_line)).to be true
  end

  it "maps up arrow to line_up" do
    msg = Chamomile::KeyMsg.new(key: :up, mod: [])
    expect(Chamomile::KeyBinding.key_matches?(msg, key_map, :line_up)).to be true
  end

  it "maps down arrow to line_down" do
    msg = Chamomile::KeyMsg.new(key: :down, mod: [])
    expect(Chamomile::KeyBinding.key_matches?(msg, key_map, :line_down)).to be true
  end
end
