...
RSpec.describe Chamomile::Stopwatch do
  ...
  describe "#start_cmd" do
    ...
    it "produces a StopwatchTickMsg with matching id" do
      ...
      expect(msg).to be_a(Chamomile::StopwatchTickMsg)
  ...
  describe "#update" do
    ...
    it "ignores StopwatchTickMsg with wrong id" do
      sw = described_class.new
      msg = Chamomile::StopwatchTickMsg.new(id: "wrong", tag: 0, time: Time.now)
      cmd = sw.update(msg)
      expect(cmd).to be_nil
      expect(sw.elapsed).to eq(0.0)
    end
  ...
  describe "edge cases" do
    ...
    it "ignores StopwatchTickMsg with future tag" do
      sw = described_class.new
      msg = Chamomile::StopwatchTickMsg.new(id: sw.id, tag: 999, time: Time.now)
      cmd = sw.update(msg)
      expect(cmd).to be_nil
    end
