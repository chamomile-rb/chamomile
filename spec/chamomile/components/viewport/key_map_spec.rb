...
RSpec.describe "Chamomile::Viewport::DEFAULT_KEY_MAP" do
  let(:key_map) { Chamomile::Viewport::DEFAULT_KEY_MAP }
  ...
  it "maps k to up" do
    ...
    expect(Chamomile::KeyBinding.key_matches?(msg, key_map, :up)).to be true
  end

  it "maps j to down" do
    msg = Chamomile::KeyMsg.new(key: "j", mod: [])
    expect(Chamomile::KeyBinding.key_matches?(msg, key_map, :down)).to be true
  end

  it "maps space to page_down" do
    msg = Chamomile::KeyMsg.new(key: " ", mod: [])
    expect(Chamomile::KeyBinding.key_matches?(msg, key_map, :page_down)).to be true
  end
end
