...
RSpec.describe Chamomile::SpinnerType do
...
RSpec.describe Chamomile::Spinners do
  all_types = {
  ...
  all_types.each do |name, expected|
    describe name.to_s do
      ...
      it "is a SpinnerType" do
        expect(spinner_type).to be_a(Chamomile::SpinnerType)
      end
  ...
  it "defines exactly 12 spinner types" do
    types = described_class.constants.select { |c| described_class.const_get(c).is_a?(Chamomile::SpinnerType) }
