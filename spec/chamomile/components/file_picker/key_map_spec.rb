...
RSpec.describe "Chamomile::FilePicker::DEFAULT_KEY_MAP" do
  let(:key_map) { Chamomile::FilePicker::DEFAULT_KEY_MAP }
  ...
  it "maps enter to open" do
    ...
    expect(Chamomile::KeyBinding.key_matches?(msg, key_map, :open)).to be true
  end

  it "maps backspace to back" do
    msg = Chamomile::KeyMsg.new(key: :backspace, mod: [])
    expect(Chamomile::KeyBinding.key_matches?(msg, key_map, :back)).to be true
  end

  it "maps . to toggle_hidden" do
    msg = Chamomile::KeyMsg.new(key: ".", mod: [])
    expect(Chamomile::KeyBinding.key_matches?(msg, key_map, :toggle_hidden)).to be true
  end
end
