...
RSpec.describe Chamomile::Table do
  def key(k, mod: []) = Chamomile::KeyMsg.new(key: k, mod: mod)

  let(:columns) do
    [
      Chamomile::Table::Column.new(title: "Name", width: 10),
      Chamomile::Table::Column.new(title: "Age", width: 5),
    ]
  end
  ...
  describe "Column" do
    it "is a Data.define with title and width" do
      col = Chamomile::Table::Column.new(title: "Name", width: 10)
